export const InvarianceReviewAbi = [
  {
    "type": "function",
    "name": "ADMIN_ROLE",
    "inputs": [],
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract IInvarianceEscrow"
      }
    ],
    "stateMutability": "view"
  },
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct InvarianceReview.Review",
        "components": [
          {
            "name": "reviewId",
            "type": "bytes32",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct InvarianceReview.ReviewStats",
        "components": [
          {
            "name": "totalReviews",
            "type": "uint256",
